export const JobList = [
    ...
    },
    {
        ...
        description_cv: '<ul><li>In charge of all the production for 2 years out of 3</li><li>Developed and maintained WordPress and Drupal sites</li><li>SEO optimized already created sites in WordPress, Drupal and Magento</li></ul>',
