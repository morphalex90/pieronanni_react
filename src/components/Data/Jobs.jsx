export const JobList = [
    {
        ...
        location: 'London, UK',
        description: ['Develop the platform', 'Be in charge of delivering functionalities and handle other people\'s code'],
        description_cv: null,
    ...
    },
    {
        ...
        location: 'London, UK',
        description: ['Develop and publish the first Drupal 8 and 9 projects of the company', 'Optimize sites with best practices and from a code / security prospective'],
        description_cv: null,
    ...
    },
    {
        ...
        description: ['description magic'],
        description_cv: 'description cv',
